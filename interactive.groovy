...
Grape.grab([group:'org.seleniumhq.selenium', module:'selenium-firefox-driver', version:'2.39.0'])
Grape.grab([group:'org.seleniumhq.selenium', module:'selenium-support',version:'2.39.0'])
import geb.*
